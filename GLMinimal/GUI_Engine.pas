...
uses SysUtils, {$IFDEF Win32}Winapi.Windows,{$ENDIF} Classes, AsphyreTypes, Controls, SyncObjs, GUI_Element;
...
uses System_Initializer, Main, System_Log, GUI_Element_Edit,
...
begin
  ...
  begin
    ...
    if (seek) then
      ...
      begin
        print(IntToStr(integer(element)) + ' vs ' + IntToStr(integer(self.element[i])));
